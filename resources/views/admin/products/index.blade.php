                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                @php
                                    $productRouteKey = !empty($product->slug) ? $product->slug : $product->id;
                                @endphp
                                @if($productRouteKey)
                                <a href="{{ route('admin.products.show', $productRouteKey) }}" class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.products.edit', $productRouteKey) }}" class="btn btn-sm btn-outline-secondary">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('admin.products.destroy', $productRouteKey) }}" method="POST" class="d-inline delete-form" data-name="{{ $product->name }}">
                                    @csrf
                                    @method('DELETE')
