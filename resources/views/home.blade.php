...
.subcategory-card:hover {
  ...
  box-shadow: 0 12px 30px rgba(107, 178, 82, 0.15);
  border-color: rgba(107, 178, 82, 0.5);
}
...
/* ====== Promo Banner ====== */
.promo-banner {
  background: linear-gradient(135deg, #183a14 0%, #2d5a27 40%, #5ba840 100%);
  border-radius: 16px;
  padding: 36px 40px;
  margin: 24px 0;
