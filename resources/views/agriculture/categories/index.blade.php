            ...
            <div class="col-xl-10">
                <div class="d-flex align-items-start gap-4">
                    <div class="flex-shrink-0">
                        <div class="bg-success" style="width: 5px; height: 110px; border-radius: 3px;"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-2" style="max-width: 680px;">
                            Find the right tools, equipment and supplies for your farm or garden. 
                            From soil preparation to harvesting — everything is organized by category.
                        </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card h-100 border-0 shadow-sm category-card {{ ($category->in_stock_products_count ?? 0) == 0 ? 'out-of-stock' : '' }}">
                        ...
                        <div class="card-body d-flex flex-column">
                            <h4 class="card-title fw-bold text-dark mb-3">{{ $category->name }}</h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center mb-5">
                <h2 class="h3 fw-bold text-primary mb-4">Featured Categories</h2>
                <p class="text-muted">
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-3">
                <div class="text-center p-4">
                    ...
                    <h4 class="h5 fw-bold text-primary mb-3">Fresh Vegetables</h4>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="text-center p-4">
                    ...
                    <h4 class="h5 fw-bold text-primary mb-3">Organic Fruits</h4>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="text-center p-4">
                    ...
                    <h4 class="h5 fw-bold text-primary mb-3">Grains & Cereals</h4>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="text-center p-4">
                    ...
                    <h4 class="h5 fw-bold text-primary mb-3">Dairy Products</h4>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-lg-end">
                <a href="{{ route('contact') }}" class="btn btn-light btn-md fw-bold text-primary">Contact Us</a>
            </div>
        </div>
    </div>
</section>
