            ...
            <div class="card-body">
                <form action="{{ route('admin.subcategories.update', $subcategory) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @if($subcategory->image)
                            <div class="mb-3">
                                ...
                                <div>
                                    ...
                                    @endphp
                                    <img src="{{ $imageUrl }}" alt="{{ $subcategory->name }}" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                </div>
                        ...
                        <div class="form-text">Recommended size: 400x400px or larger. Max file size: 2MB. Formats: JPEG, PNG, WebP. @if($subcategory->image) Uploading a new image will replace the current one. @endif</div>
                        @error('image')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
