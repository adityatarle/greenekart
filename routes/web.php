...
// Home page - Current homepage (using agriculture.home since it's used throughout the app)
...
// Old home route (redirects to main home for backward compatibility)
Route::get('/old-home', function() {
    return redirect()->route('agriculture.home', [], 301);
});
