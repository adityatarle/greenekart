...
class DealerManagementController extends Controller
{
    ...
    /**
     * Export dealer registrations to Excel (respects current filters)
     */
    public function export(Request $request)
    {
        ...
        $filename = 'dealers-' . now()->format('Y-m-d-His') . '.xlsx';

        return Excel::download(new DealersExport($registrations), $filename);
    }
