            ...
            <div class="card-body">
                <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Recommended size: 400x400px or larger. Max file size: 2MB. Formats: JPEG, PNG, WebP. @if($category->image) Uploading a new image will replace the current one. @endif</div>
                        @error('image')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
